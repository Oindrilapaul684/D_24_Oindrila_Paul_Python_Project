...
print('-' * 10,"WELCOME TO STUDENT EXAMINATION PORTAL")
...
#gradation on the basis of obtained total marks
def grade(num):
    if num >= 90:
...
#removal of particular student from whole directory
def remove(string):
...
#show graph for different department
